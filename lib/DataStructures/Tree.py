...
if __name__ == "__main__":
    t = Tree()
    t.process_path("/folder1/file1")
    t.process_path("/folder1/file2")
    t.process_path("/folder1/folder2/file2")
    t.process_path("/folder1/folder3/file3")
    t.process_path("/folder4")
